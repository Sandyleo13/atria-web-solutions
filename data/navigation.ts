export type ServiceNavItem = { title: string; href: string };
...
export const SERVICE_NAVIGATION: ServiceNavItem[] = [
  ...
  { title: "Website Designing & Development", href: "/services#website-designing-development" },
  { title: "Mobile App Development", href: "/services#mobile-app-development" },
  { title: "Email Marketing", href: "/services#email-marketing" },
  { title: "Online Reputation Management", href: "/services#online-reputation-management" },
];

export const NAVIGATION: NavItem[] = [
  { title: "Home", href: "/" },
  { title: "About", href: "/about" },
  { title: "Services", href: "/services", children: SERVICE_NAVIGATION },
